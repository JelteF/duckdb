...
DUCKDB_REGISTER_TRANSFORM_RESULT_TYPE("duckdb.transform_result.transform_result_ptr",
...
public:
	...
	static transform_result_ptr FinalizeTypeTrampoline(PEGTransformer &transformer,
	                                                               GeneratedTransformProcess &process);
	...
	static transform_result_ptr FinalizeOidsTrampoline(PEGTransformer &transformer,
	                                                               GeneratedTransformProcess &process);
	...
	static transform_result_ptr FinalizeTermTrampoline(PEGTransformer &transformer,
	                                                               GeneratedTransformProcess &process);
	...
	static transform_result_ptr FinalizeAsofTrampoline(PEGTransformer &transformer,
	                                                               GeneratedTransformProcess &process);
